...
//     session_destroy();
//     if(!$isIndex) header('Location: ../validation/admin.html');
//   }
?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="getLog()">
    ...
    <section id="sidebar">
        <a href="#" class="brand">
            ...
            <span class="text" id="usr-txt">Hello, <?php echo $_SESSION['name']; ?>!</span>
        </a>
